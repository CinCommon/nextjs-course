    ...
    return (
        <div className="relative mx-auto max-w-md overflow-hidden rounded-lg bg-white shadow">
            ...
            <div className="absolute inset-x-0 bottom-0 z-20 p-4">
                ...
                <p className="mt-1 text-white text-opacity-80">Sailboat UI is a modern UI component library for
                    Tailwind CSS. Get started with 150+ open source components.</p>
            </div>
        </div>
    );
};
